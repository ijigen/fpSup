...
w("# +0x6000 onward is left for whatever is loaded alongside -- the gyro logger")
w("# puts its state and its two 16 KiB halves there. Reserve the whole span up")
w("# front rather than writing past a 4 KiB allocation and hoping the tail is free.")
w("memmgr bufmem get 0 0x10000 0x40")
w("")
w("# --- start the worker --------------------------------------------------------")
