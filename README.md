...
| 4 | [**open gate**](projects/open-gate.md) | Recording the sensor's full 3:2 area | **working** — 3024×2010 3:2 CinemaDNG at 29.97, DNG cropped to 3008×2000, rolling shutter 9.221 ms. Live view, playback and its own menu entry all verified. Ver.5.02 only. Card in [`opengate/`](opengate/) |
...
| 4 | [**open gate**](projects/open-gate.md) | 用感光元件完整的 3:2 面積錄影 | **可用** —— 3024×2010 3:2 CinemaDNG @29.97,DNG 裁切 3008×2000,捲簾 9.221 ms。live view、機內回放、獨立選單項目均已驗證。僅限 Ver.5.02。卡片在 [`opengate/`](opengate/) |
