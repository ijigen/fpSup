...
|---|---|---|
<!-- releases:begin:en -->
| [`fpsup-gyro`](releases/fpsup-gyro-v1.12.0/) | v1.12.0 | Writes Gyroflow's `.gcsv` and `.json` while recording — every sample at 2500 Hz, distortion read off the lens. |
...
|---|---|---|
<!-- releases:begin:zh -->
| [`fpsup-gyro`](releases/fpsup-gyro-v1.12.0/) | v1.12.0 | 錄影當下就把 Gyroflow 要的 `.gcsv` 與 `.json` 寫進片段資料夾。2500 Hz 每個樣本都在,畸變直接讀鏡頭。 |
