...
| 2 | [**color sup**](projects/color-sup.md) | Colour science and the DaVinci workflow | **shipped** — a working DCTL |
| 3 | [**fpRemote**](projects/fp-remote.md) | Wireless bridge, low-res streaming, PTP control | **wired half is a working tool** — [sigma-fp-bridge](https://github.com/ijigen/sigma-fp-bridge); wireless not started |
| 4 | [**sensor lab sup**](projects/sensor-lab-sup.md) | IMX410 modes, ISO, gain, sensor control | **research complete** — [explainer](https://ijigen.github.io/fpSup/) published; one open item |
| 5 | [**gyro sup**](projects/gyro-sup.md) | Gyro, six-axis logging, Gyroflow workflow | **core verified on hardware**, integration pending |
| 6 | [**focus sup**](projects/focus-sup.md) | DFD, focus model, lens control, follow focus | AF decompiled in depth; a host-side attempt measured its own limits |
...
| 2 | [**color sup**](projects/color-sup.md) | 色彩科學與 DaVinci 工作流 | **已有成品** — 可用的 DCTL |
| 3 | [**fpRemote**](projects/fp-remote.md) | 外部無線橋接、低解析度串流、PTP 外控 | **有線那半是能用的工具** — [sigma-fp-bridge](https://github.com/ijigen/sigma-fp-bridge);無線未開始 |
| 4 | [**sensor lab sup**](projects/sensor-lab-sup.md) | IMX410 模式、ISO、gain 與 sensor 控制 | **研究完成** — [互動說明頁](https://ijigen.github.io/fpSup/)已發布;一項未解 |
| 5 | [**gyro sup**](projects/gyro-sup.md) | Gyro、六軸記錄與 Gyroflow 工作流 | **核心已實機驗證**,整合中 |
| 6 | [**focus sup**](projects/focus-sup.md) | DFD、焦點模型、鏡頭控制與追焦 | AF 已深度反編譯;主機端的嘗試量出了自己的極限 |
