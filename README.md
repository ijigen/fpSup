...
| 3 | [**gyro sup**](projects/gyro-sup.md) | Gyro, six-axis logging, Gyroflow workflow | **released** — [fpGyroSup v1](gyro/release/), card in and shoot, no computer |
...
| 3 | [**gyro sup**](projects/gyro-sup.md) | Gyro、六軸記錄與 Gyroflow 工作流 | **已發布** — [fpGyroSup v1](gyro/release/),插卡拍攝,全程不接電腦 |
