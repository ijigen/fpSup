...
separated. The way to do it is in `../research/imaging-hw/notes/RAW_COMPRESSION_RESEARCH.md`: time two
...
做法寫在 `../research/imaging-hw/notes/RAW_COMPRESSION_RESEARCH.md`:量兩三個不同尺寸再擬合。
